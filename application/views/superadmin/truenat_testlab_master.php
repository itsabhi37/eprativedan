    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">TrueNat Test Lab Master</span>
            </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">TrueNat Test Lab Master</h4>
            <!-- <p class="mg-b-0">A collection basic to advanced table design that you can use to your data.</p> -->
        </div>

        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-17 mg-t-5 mg-b-10">TrueNat Test Lab Master Section</h6>
                <hr style="border-top: 2px double #00B297;" />
                <!-- <p class="mg-b-30 tx-gray-600">A demo for using custom layout for validation.</p> -->
                <?php
                if ($this->uri->segment(4)) {
                    echo form_open_multipart('superadmin/dashboard/update_truenat_testlab_master', 'data-parsley-validate');
                } else {
                    echo form_open_multipart('superadmin/dashboard/insert_truenat_testlab_master', 'data-parsley-validate');
                }
                ?>
                <?php
                    if ($this->uri->segment(4)) {
                        ...
                        <div class="form-layout form-layout-4">
                            <div class="row">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                   <?php
                                    if ($this->uri->segment(4)) {
                                        echo '<input type="text" name="txtName" value="'.$ettlName.'" class="form-control" placeholder="TrueNat Testing Lab Name" required>';
                                        echo '<input class="form-control" type="text" name="ttlId" value="' . $ettlId . '" readonly="true" hidden="true">';
                                    } else {
                                        echo '<input type="text" name="txtName" class="form-control" placeholder="TrueNat Testing Lab Name" required>';
                                    }
                                ?>
                                </div>
                            </div><!-- row -->
                            <div class="form-layout-footer mg-t-30">
                                ...
                                <a class="btn btn-secondary text-capitalize" href="<?= base_url('superadmin/dashboard/truenat_testlab_master') ?>">Cancel</a>
            ...
            <table id="datatable1" class="table display responsive nowrap"width="100%">
              <thead class="thead-colored thead-teal">
                <tr>
                  ...
                  <th class="wd-15p text-center">TreuNat LAB Name</th>
                            ...
                            <?php if (count($totalEntries)) { ?>
                                ...
                                foreach ($totalEntries as $tot) {
                                    ...
                                    <tr class="text-inverse">
                                        ...
                                        <td class="text-center"><?php echo $tot->ttlName; ?></td>
                                        <td class="text-center">
                                        <a href="<?= base_url('superadmin/dashboard/edit_truenat_testlab_master/' . $tot->ttlId ) ?>" class="btn btn-teal btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                                        </td>
