    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item" href="#">PMCH Reports</a>
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <?php
                echo form_open_multipart('superadmin/dashboard/show_truenat_reports', 'data-parsley-validate');
                ?>
                    ...
                    <div class="col-xl-6">
                        <div class="form-layout form-layout-4">
                            ...
                            <div class="form-layout-footer mg-t-30">
                                ...
                                <a class="btn btn-secondary text-capitalize" href="<?= base_url('superadmin/dashboard/truenat_reports') ?>">Cancel</a>
