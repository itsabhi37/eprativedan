    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <?php
                echo form_open_multipart('department/cs/show_health_report', 'data-parsley-validate');
                ?>
                    ...
                    <div class="col-xl-6">
                        <div class="form-layout form-layout-4">
                            ...
                            <div class="form-layout-footer mg-t-30">
                                ...
                                <a class="btn btn-secondary text-capitalize" href="<?= base_url('department/cs/health_report') ?>">Cancel</a>
